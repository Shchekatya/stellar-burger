...
export const BurgerIngredients=(props) => { 
  ...
  return (    
    ...
    <nav className={bIng.nav}>
      <a href='#buns' className="text text_type_main-small pb-4 pt-4">Булки</a>
      <a href='#sauces' className="text text_type_main-small pb-4 pt-4">Соусы</a>
      <a href='#mains' className="text text_type_main-small pb-4 pt-4">Начинки</a>
    </nav>
    ...
    <h2 className="text text_type_main-medium mt-10 mb-6" id='sauces'>Соусы</h2>
    <Ingredients type='sauce' items={props.items} onAdd={props.onAdd}/> 
    <h2 className="text text_type_main-medium mt-10 mb-6" id='mains'>Начинки</h2>
